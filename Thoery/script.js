...
function handleClick() {
  ...
  const activeClass1 = "active";
  if (h1.className === activeClass1) {
    h1.className = "";
  } else {
    h1.className = activeClass1;
  }
  ...
  const activeClass2 = "active";
  if (h1.classList.contains(activeClass2)) {
    h1.classList.remove(activeClass2);
  } else {
    h1.classList.add(activeClass2);
  }
